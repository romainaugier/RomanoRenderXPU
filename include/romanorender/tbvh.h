...
ROMANORENDER_FORCE_INLINE Vec3F operator+(const Vec3F& a, const Vec3F& b) { return Vec3F(a.x + b.x, a.y + b.y, a.z + b.z); }
ROMANORENDER_FORCE_INLINE Vec4F operator+(const Vec4F& a, const Vec4F& b) { return Vec4F(a.x + b.x, a.y + b.y, a.z + b.z, a.w + b.w); }
ROMANORENDER_FORCE_INLINE Vec4F operator+(const Vec4F& a, const Vec3F& b) { return Vec4F(a.x + b.x, a.y + b.y, a.z + b.z, a.w); }
ROMANORENDER_FORCE_INLINE Vec2F operator-(const Vec2F& a, const Vec2F& b) { return Vec2F(a.x - b.x, a.y - b.y); }
ROMANORENDER_FORCE_INLINE Vec3F operator-(const Vec3F& a, const Vec3F& b) { return Vec3F(a.x - b.x, a.y - b.y, a.z - b.z); }
ROMANORENDER_FORCE_INLINE Vec4F operator-(const Vec4F& a, const Vec4F& b) { return Vec4F(a.x - b.x, a.y - b.y, a.z - b.z, a.w - b.w); }
ROMANORENDER_FORCE_INLINE void operator+=(Vec2F& a, const Vec2F& b) { a.x += b.x; a.y += b.y; }
ROMANORENDER_FORCE_INLINE void operator+=(Vec3F& a, const Vec3F& b) { a.x += b.x; a.y += b.y; a.z += b.z; }
ROMANORENDER_FORCE_INLINE void operator+=(Vec4F& a, const Vec4F& b) { a.x += b.x; a.y += b.y; a.z += b.z; a.w += b.w; }
ROMANORENDER_FORCE_INLINE Vec2F operator*(const Vec2F& a, const Vec2F& b) { return Vec2F(a.x * b.x, a.y * b.y); }
ROMANORENDER_FORCE_INLINE Vec3F operator*(const Vec3F& a, const Vec3F& b) { return Vec3F(a.x * b.x, a.y * b.y, a.z * b.z); }
ROMANORENDER_FORCE_INLINE Vec4F operator*(const Vec4F& a, const Vec4F& b) { return Vec4F(a.x * b.x, a.y * b.y, a.z * b.z, a.w * b.w); }
...
ROMANORENDER_FORCE_INLINE Vec3F operator/(float b, const Vec3F& a) { return Vec3F(b / a.x, b / a.y, b / a.z); }
ROMANORENDER_FORCE_INLINE Vec4F operator/(float b, const Vec4F& a) { return Vec4F(b / a.x, b / a.y, b / a.z, b / a.w); }
ROMANORENDER_FORCE_INLINE void operator*=(Vec3F& a, const float b) { a.x *= b; a.y *= b; a.z *= b; }
