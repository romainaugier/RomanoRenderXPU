...
__device__ __forceinline__ float3 operator/(const float3& vec, const float3& other) noexcept
{
    return make_float3(__fdiv_rn(vec.x, other.x),
...
__device__ __forceinline__ float3 sum_float3(const float3& v1,
                                             const float3& v2,
                                             const float3& v3) noexcept
{
...
__device__ __forceinline__ float3 lerp_float3f(const float3& a,
                                               const float3& b,
...
__device__ __forceinline__ float3 lerp_float3v(const float3& a,
                                               const float3& b,
